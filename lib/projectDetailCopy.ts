...
/** 图片块：证书、截图等，caption 可省略 */
export type ProjectImageBlock = { kind: "image"; caption?: string; src: string; alt?: string };
...
export type SectionBlock = ProjectTextBlock | ProjectCodeBlock | ProjectTableBlock | ProjectImageBlock;
